...
load_unitizers <- function(
  ...
  for(i in valid.idx) {
    ...
    # where our state objects were corrupted; really this should be handled in a
    # more systematic way like we do for broader validation; if this happens
    # more often we can look into that
