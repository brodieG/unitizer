...
unitizer>
```
`unitizer` is telling us the value of our test does not match the reference value.  Notice at the top how `unitizer` suggests we use `.new` and `.ref` to compare our results.  Consider:
```
unitizer> .new
    intercept         slope           rsq
