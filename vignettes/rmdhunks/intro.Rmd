...
With `unitizer` you interactively review your code, as you would when informally
testing it by typing it at the R prompt.  Then, with a single keystroke,
`unitizer` stores the code, the value and any conditions (warnings, errors,
etc.) it produced, and turns the lot into a formal regression test.
