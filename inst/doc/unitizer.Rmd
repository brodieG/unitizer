...
in a fresh R session prior to running tests to avoid conflicts with loaded
whatever libraries you happen to have loaded at the time.  Your session state is
restored when `unitizer` exits.  The following aspects of state can
be actively tracked and managed:
