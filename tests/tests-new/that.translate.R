...
target.dir <- file.path(target.dir.base, "helper", "translate", 
    "unitizer")
...
#     expect_error(testthat_translate_file(test.file, target.dir, 
#         prompt = "always", interactive.mode = FALSE), "Unable to proceed")
# })
# - "Prompt to create dir" -----------------------------------------------------


# expect_error(testthat_translate_file(test.file, target.dir, prompt = "always", 
#     interactive.mode = FALSE), "Unable to proceed")
...
#     expect_equal_to_reference(res1.txt, file.path("helper", "refobjs", 
#         "translate_res1.rds"))
#     expect_equal(res1.txt, res2.txt)
#     expect_error(testthat_translate_file(test.file, target.dir, 
#         prompt = "always", interactive.mode = FALSE), "Unable to proceed")
#     untz <- get_unitizer(file.path(target.dir, "translate2.unitizer"))
#     expect_equal_to_reference(untz@items.ref.calls.deparse, file.path("helper", 
#         "refobjs", "translate_res2.rds"))
#     expect_equal(lapply(unitizer:::as.list(untz@items.ref), function(x) x@data@value[[1L]]), 
...
unitizer:::capture_output(res2 <- testthat_translate_dir(test.dir, 
    target.dir))
# test_that("translate a dir", {
#     expect_equal_to_reference(lapply(res2, readLines), file.path("helper", 
#         "refobjs", "translate_res3.rds"))
#     untz <- get_unitizer(file.path(target.dir, "translate2.unitizer"))
#     expect_equal_to_reference(untz@items.ref.calls.deparse, file.path("helper", 
#         "refobjs", "translate_res4.rds"))
#     expect_equal(lapply(unitizer:::as.list(untz@items.ref), function(x) x@data@value[[1L]]), 
#         list(dummy, 1:10, 42, 24, 24, NULL, "yoyo", NULL))
#     expect_error(testthat_translate_dir(test.dir, target.dir), 
...
# expect_error(testthat_translate_dir(test.dir, target.dir), "contains files so we cannot proceed")
