...
#     expect_error(unitizer_sect("mytest", expr.1, letters, letters), 
#         "Argument `compare` must be \"testFuns\" or a function")
#     expect_error(unitizer_sect("mytest", expr.1, letters, identity), 
#         "does not have at least two arguments")
#     expect_error(unitizer_sect("mytest", expr.2), "Argument `expr` must be an expression")
#     expect_error(unitizer_sect("mytest", matrix(1:9, nrow = 3)), 
...
#     expect_is(sect.2 <- unitizer_sect("mytest", {
#         1 + 1
#         b <- 5
#         matrix(integer(), nrow = b, ncol = b)
...
#     expect_is(sect.5 <- unitizer_sect("mytest", expression(1 + 
#         1, b <- 5, matrix(integer(), nrow = b, ncol = b))), "unitizerSectionExpression")
#     expect_identical(sect.1, sect.5)
#     expect_is(sect.1 <- unitizer_sect("mytest", expr.1, compare = identical), 
#         "unitizerSectionExpression")
...
unitizer_sect(1:3)
# expect_error(unitizer_sect(letters), "must be a 1 length character vector")
unitizer_sect(letters)
# expect_error(unitizer_sect("mytest", expr.1, 1:3), "`details` must be character")
unitizer_sect("mytest", expr.1, 1:3)
...
# expect_identical(sect.1, sect.4)
sect.1
expect_is(sect.5 <- unitizer_sect("mytest", expression(1 + 1, 
...
expr.4 <- expression(unitizer_sect("change comp funs", compare = testFuns(value = identical, 
    output = all.equal, message = all.equal, conditions = function(x, 
        y) TRUE), {
    50 + runif(1)/10^10
    message("Hello There", runif(1))
    cat("Hello there", runif(1))
...
#     expect_equal(structure(c(TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, 
#         TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 
#         TRUE, TRUE, TRUE, TRUE, TRUE), .Dim = 4:5, .Dimnames = list(NULL, 
#         c("value", "conditions", "output", "message", "aborted"))), 
#         my.unitizer2@tests.result)
#     expect_equal(structure(c(FALSE, TRUE, TRUE, TRUE, TRUE, FALSE, 
#         TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 
#         TRUE, TRUE, TRUE, TRUE, TRUE), .Dim = 4:5, .Dimnames = list(NULL, 
#         c("value", "conditions", "output", "message", "aborted"))), 
#         my.unitizer3@tests.result)
#     expect_equal(structure(c(FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, 
#         TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, 
#         FALSE, TRUE, TRUE, TRUE, TRUE), .Dim = 4:5, .Dimnames = list(NULL, 
#         c("value", "conditions", "output", "message", "aborted"))), 
...
#     TRUE, TRUE, TRUE, TRUE), .Dim = 4:5, .Dimnames = list(NULL, 
#     c("value", "conditions", "output", "message", "aborted"))), 
#     my.unitizer2@tests.result)
structure(c(TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, 
    TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 
    TRUE, TRUE), .Dim = 4:5, .Dimnames = list(NULL, c("value", 
    "conditions", "output", "message", "aborted")))
# expect_equal(structure(c(FALSE, TRUE, TRUE, TRUE, TRUE, FALSE, 
#     TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 
#     TRUE, TRUE, TRUE, TRUE), .Dim = 4:5, .Dimnames = list(NULL, 
#     c("value", "conditions", "output", "message", "aborted"))), 
#     my.unitizer3@tests.result)
structure(c(FALSE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, 
    TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 
    TRUE, TRUE), .Dim = 4:5, .Dimnames = list(NULL, c("value", 
    "conditions", "output", "message", "aborted")))
# expect_equal(structure(c(FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, 
...
#     c("value", "conditions", "output", "message", "aborted"))), 
#     my.unitizer4@tests.result)
structure(c(FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 
    TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, FALSE, TRUE, 
    TRUE, TRUE, TRUE), .Dim = 4:5, .Dimnames = list(NULL, c("value", 
    "conditions", "output", "message", "aborted")))
