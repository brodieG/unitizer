library(testthat)
# context("Search")
old.opts <- options(unitizer.search.path.keep = c(getOption("unitizer.search.path.keep"), 
    "package:testthat"))
on.exit({
...
#     expect_true(all(vapply(pkg.dat, function(x) is.list(x) && 
...
# expect_error(unitizer:::is.loaded_package(1))
unitizer:::is.loaded_package(1)
# expect_error(unitizer:::is.loaded_package(letters))
unitizer:::is.loaded_package(letters)
# expect_false(unitizer:::is.loaded_package("Autoloads"))
unitizer:::is.loaded_package("Autoloads")
# expect_true(is.list(pkg.dat <- unitizer:::get_package_data()))
...
all(vapply(pkg.dat, function(x) is.list(x) && identical(names(x), 
    c("names", "lib.loc", "version")), logical(1L)))
...
#     if (length(search.init) < 6L) 
#         stop("Unexpetedly short search path")
...
on.exit(untz.glob$release())
# expect_error(unitizer:::move_on_path(5L, 2L, untz.glob))
unitizer:::move_on_path(5L, 2L, untz.glob)
# expect_error(unitizer:::move_on_path(1L, 2L, untz.glob))
unitizer:::move_on_path(1L, 2L, untz.glob)
unitizer:::move_on_path(2L, 5L, untz.glob)
...
# expect_equal(environmentName(untz.glob$tracking@search.path[[st.3@search.path]]$search.path[[4L]]), 
#     "package:unitizerdummypkg2")
environmentName(untz.glob$tracking@search.path[[st.3@search.path]]$search.path[[4L]])
# Attach a list
attach(unitizer.dummy.list)
search.ref <<- untz.glob$state()
# expect_equal(environmentName(untz.glob$tracking@search.path[[search.ref@search.path]]$search.path[[2L]]), 
#     "unitizer.dummy.list")
environmentName(untz.glob$tracking@search.path[[search.ref@search.path]]$search.path[[2L]])
# expect_identical(as.list(untz.glob$tracking@search.path[[search.ref@search.path]]$search.path[[2L]]), 
#     unitizer.dummy.list)
as.list(untz.glob$tracking@search.path[[search.ref@search.path]]$search.path[[2L]])
...
# expect_equal(names(untz.glob$tracking@search.path[[curr.sp.ind]]$search.path), 
#     search())
names(untz.glob$tracking@search.path[[curr.sp.ind]]$search.path)
# expect_identical(as.list(untz.glob$tracking@search.path[[curr.sp.ind]]$search.path[[4L]]), 
#     unitizer.dummy.list.2)
...
#     expect_identical(as.list(as.environment("unitizer.dummy.list")), 
#         unitizer.dummy.list.2)
...
#     expect_identical(search(), sp.keep[match(names(search.init$search.path), 
#         sp.keep, nomatch = 0L)])
#     untz.glob$resetFull()
#     untz.glob$release()
#     expect_true(unitizer:::search_dat_equal(unitizer:::search_as_envs(), 
