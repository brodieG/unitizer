if (!file_test("-d", file.path("helper", "refobjs"))) stop("Make sure wd is set to tests/testthat")
library(unitizer)
library(testthat)
...
# Bad history
bad.hist <- try(unitize("helper/trivial.R", history = list()), 
    silent = TRUE)
# test_that("bad history", {
#     expect_is(bad.hist, "try-error")
#     expect_match(conditionMessage(attr(bad.hist, "condition")), 
#         "must be the name")
# })
# - "bad history" --------------------------------------------------------------
...
expect_is(bad.hist, "try-error")
# expect_match(conditionMessage(attr(bad.hist, "condition")), "must be the name")
...
# test_that("bad seed", {
#     expect_equal_to_reference(unitizer:::clean_eval_exp(txtopt1), 
#         file.path("helper", "refobjs", "unitize_txtop1.rds"))
#     expect_equal_to_reference(txtopt2, file.path("helper", "refobjs", 
#         "unitize_txtop2.rds"))
# })
# - "bad seed" -----------------------------------------------------------------
...
txt1 <- unitizer:::capture_output(untz1 <- try(unitize_dir(test.dir, 
    get_store_id, interactive.mode = TRUE)))
unitizer:::read_line_set_vals(c("Y", "Q"))
txt2 <- unitizer:::capture_output(untz2 <- unitize_dir(test.dir, 
    get_store_id, interactive.mode = TRUE))
...
#     expect_equal_to_reference(txt1, file.path("helper", "refobjs", 
#         "unitize_txtcd1.rds"))
#     expect_equal_to_reference(txt2, file.path("helper", "refobjs", 
#         "unitize_txtcd2.rds"))
# })
# - "create dir" ---------------------------------------------------------------
...
txt3aa <- unitizer:::capture_output(unitize_dir(test.dir, interactive.mode = TRUE))
...
unitizer:::read_line_set_vals(c("A", "Y", "Y", "Y", "Y", "Y", 
    "Q", "Q", "R", "A", "Y", "Y", "Q", "Q"))
txt3a <- unitizer:::capture_output(untz3a <- unitize_dir(test.dir, 
...
unitizer:::read_line_set_vals(c("3000", "3", "Y", "Y", "Y", "Y", 
    "R"))
txt3b <- unitizer:::capture_output(untz3b <- unitize_dir(test.dir, 
    interactive.mode = TRUE))
...
#     expect_equal_to_reference(untz3a.all.pr, file.path("helper", 
#         "refobjs", "unitize_resprint1.rds"))
#     expect_equal_to_reference(untz3a.first.pr, file.path("helper", 
#         "refobjs", "unitize_resprint2.rds"))
#     expect_equal_to_reference(untz3b.all.pr, file.path("helper", 
#         "refobjs", "unitize_resprint3.rds"))
#     expect_match(untz3a.empty.pr[1], "No unitizers")
#     expect_match(untz3a.first.bad.pr[2], "untranslateable")
# })
# - "print untizer result" -----------------------------------------------------
...
untz3a.empty.pr[1]
# expect_match(untz3a.first.bad.pr[2], "untranslateable")
untz3a.first.bad.pr[2]
# test_that("unitize_dir", {
#     expect_equal_to_reference(txt3aa, file.path("helper", "refobjs", 
#         "unitize_txtdir_quitall.rds"))
#     expect_equal_to_reference(txt3a, file.path("helper", "refobjs", 
#         "unitize_txtdir.rds"))
#     expect_equal_to_reference(txt3b, file.path("helper", "refobjs", 
#         "unitize_txtdir1.rds"))
#     expect_identical(class(untz3a), "unitizer_results")
#     expect_identical(lapply(untz3a, class), replicate(3L, c("unitizer_result", 
#         "data.frame"), simplify = FALSE))
#     expect_equal_to_reference(untz3a.cpy, file.path("helper", 
#         "refobjs", "unitize_res1.rds"))
...
#     "data.frame"), simplify = FALSE))
lapply(untz3a, class)
expect_equal_to_reference(untz3a.cpy, file.path("helper", "refobjs", 
    "unitize_res1.rds"))
# expect_equal(untz3a.get.all, c("unitizer", "unitizer", "logical"))
untz3a.get.all
# expect_equal(untz3b.get.all, c("unitizer", "unitizer", "unitizer"))
...
txt4 <- unitizer:::capture_output(unitize_dir(test.dir, state = "pristine", 
    interactive.mode = TRUE))
unitizer:::read_line_set_vals("N")
txt5 <- unitizer:::capture_output(unitize_dir(test.dir, state = "pristine", 
    interactive.mode = TRUE))
...
txt6 <- unitizer:::capture_output(try(unitize_dir(test.dir, state = "pristine", 
    interactive.mode = FALSE)))
txt7 <- unitizer:::capture_output(try(unitize(file.path(test.dir, 
    "fastlm2.R"), state = "pristine", interactive.mode = FALSE)))
options(old.keep.ns)
...
#     expect_equal_to_reference(txt4, file.path("helper", "refobjs", 
#         "unitize_nsconf1.rds"))
#     expect_equal_to_reference(txt5, file.path("helper", "refobjs", 
#         "unitize_nsconf2.rds"))
#     expect_equal_to_reference(txt6, file.path("helper", "refobjs", 
#         "unitize_errintry.rds"))
#     expect_equal_to_reference(txt7, file.path("helper", "refobjs", 
#         "unitize_nsconf3.rds"))
# })
# - "namespace conflict" -------------------------------------------------------
...
txt7aa <- unitizer:::capture_output(unitize(file.path(extra.dir, 
    "del1.R"), auto.accept = "new", interactive.mode = FALSE))
unitizer:::read_line_set_vals(c("Y", "YY", "Y", "Y"))
txt7ab <- unitizer:::capture_output(unitize(file.path(extra.dir, 
    "del2.R"), store.id = file.path(extra.dir, "del1.unitizer"), 
    interactive.mode = TRUE))
# test_that("Removing Tests", {
#     expect_equal_to_reference(txt7aa, file.path("helper", "refobjs", 
#         "unitize_rem1.rds"))
#     expect_equal_to_reference(txt7ab, file.path("helper", "refobjs", 
#         "unitize_rem2.rds"))
# })
# - "Removing Tests" -----------------------------------------------------------
...
unitizer:::read_line_set_vals(c("P", "B", "3", "N", "U", "N", 
    "N", "B", "U", "Q"))
txt7a <- unitizer:::capture_output(untz7a <- unitize(.unitizer.test.file, 
    interactive.mode = TRUE))
attr(untz7a, "test.file") <- basename(attr(untz7a, "test.file"))
attr(untz7a, "store.id") <- basename(attr(untz7a, "store.id"))
# test_that("navigate", {
#     expect_equal_to_reference(txt7a, file.path("helper", "refobjs", 
#         "unitize_nav1.rds"))
#     expect_equal_to_reference(untz7a, file.path("helper", "refobjs", 
#         "unitize_res7a.rds"))
# })
# - "navigate" -----------------------------------------------------------------
...
txt8c <- unitizer:::capture_output(try(unitize_dir(test.dir, 
    pattern = "unitize|fastlm2", interactive.mode = FALSE)))
...
unitizer:::read_line_set_vals(c("A", "Y", "Y", "Y", "Y", "Y", 
    "Y", "RR"))
txt11 <- unitizer:::capture_output(untz11 <- unitize_dir(test.dir, 
    interactive.mode = TRUE))
# test_that("review dir", {
#     expect_equal_to_reference(txt8, file.path("helper", "refobjs", 
#         "unitize_revdir1.rds"))
#     expect_equal_to_reference(txt8a, file.path("helper", "refobjs", 
#         "unitize_revdir1a.rds"))
#     expect_equal_to_reference(txt8b, file.path("helper", "refobjs", 
#         "unitize_revdir1b.rds"))
#     expect_equal_to_reference(txt8c, file.path("helper", "refobjs", 
#         "unitize_revdir1c.rds"))
#     expect_equal_to_reference(txt9, file.path("helper", "refobjs", 
#         "unitize_revdir2.rds"))
#     expect_equal_to_reference(txt10, file.path("helper", "refobjs", 
#         "unitize_revdir3.rds"))
#     expect_equal_to_reference(txt11, file.path("helper", "refobjs", 
#         "unitize_revdir4.rds"))
#     expect_equal_to_reference(txt12, file.path("helper", "refobjs", 
#         "unitize_reeval1.rds"))
#     expect_equal_to_reference(txt12a, file.path("helper", "refobjs", 
#         "unitize_reeval2.rds"))
#     expect_equal_to_reference(txt12b, file.path("helper", "refobjs", 
#         "unitize_reeval2b.rds"))
#     expect_equal_to_reference(txt13, file.path("helper", "refobjs", 
#         "unitize_multiaccept1.rds"))
#     expect_equal_to_reference(txt13a, file.path("helper", "refobjs", 
#         "unitize_multiaccept2.rds"))
#     expect_equal_to_reference(txt13b, file.path("helper", "refobjs", 
#         "unitize_multiaccept3.rds"))
# })
# - "review dir" ---------------------------------------------------------------
...
#     expect_equal_to_reference(txt20, file.path("helper", "refobjs", 
#         "unitize_multisect1.rds"))
# })
# - "multi-sect" ---------------------------------------------------------------
...
saveRDS(list(1, 2, 3), file.path(test.dir, "fastlm1.unitizer", 
    "data.rds"))
txt21 <- unitizer:::capture_output(untz21 <- unitize_dir(test.dir, 
    interactive.mode = TRUE))
txt21a <- capture.output(print(untz21))
# test_that("Load Fail", {
#     expect_equal(vapply(untz21, function(x) class(x)[[1L]], character(1L)), 
#         c("unitizerLoadFail", "unitizer_result", "unitizer_result"))
#     expect_equal_to_reference(txt21a, file.path("helper", "refobjs", 
#         "unitize_loadfailprint1.rds"))
# })
# - "Load Fail" ----------------------------------------------------------------
